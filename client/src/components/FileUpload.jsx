...
const FileUpload = () => {
        ...
        if (file) {
            try {
                ...
                const resFile = await axios({
                    ...
                    data: formData,
                    headers: {
                        pinata_api_key: `8f01eff7302970300157`,
                        pinata_secret_api_key: `e35706628c96fd62ea756e67a9444875041851ee252376db03de8345fe07dfc5
    ...
    return (
        <>
            ...
            >
                <div
                    className={`contact relative transition-all duration-1000 flex flex-col lg:flex-row lg:items-center justify-center backdrop-blur-3xl z-10 lg:top-24 top-10 lg:flex border border-[rgba(255,255,255,0.1)] bg-[rgba(255,255,255,1)] text-center lg:text-left rounded-2xl py-10 -mt-24 lg:-mt-52 m-1`}
                >
                    ...
                    <div className="form pl-6 lg:p-0 lg:w-1/4">
                        ...
                        <form className="flex pt-8 mx-2 mr-6 pb-5 space-y-6 flex-col">
                            ...
                            <motion.button
                                ...
                                className="overflow-hidden text-white hover:text-white border border-[rgba(255,255,255,0.4)] before:block before:absolute before:-inset-3 before:skew-x-[30deg] relative inline-block before:bg-blue-500 py-2 mx-1 rounded-md before:transition-all before:duration-500"
                            >
