    ...
    return (
        <>
            <motion.nav
                ...
                <div className="left">
                    <Link to='/' >
                        <h1 className={`logo font-roboto font-extrabold text-3xl`}>ID Card Manager</h1>
                    </Link>
                </div>
                ...
                <div className="right">
                    <motion.button
                        ...
                        className={`overflow-hidden border border-[rgba(255,255,255,0.4)] before:-translate-x-[12rem] hover:before:translate-x-0 before:block before:absolute before:-inset-3 before:skew-x-[30deg] relative inline-block bg-blue-500 py-2 px-4 mx-1 rounded-md `}>
