    ...
    return (
        <>
            ...
            <motion.div
                ...
                <h1 className='text-7xl font-extrabold text-black font-jost'>ID Card Manager</h1>
                <h3 className='text-black text-sm font-light font-jost my-3'>Search for your uploaded images</h3>
                <div className="input">
                    <FontAwesomeIcon className='relative text-white left-8' icon={faSearch} />
                    <input className='bg-[rgba(255,255,255,0.2)] address text-white outline-solid p-3 pl-12 pr-6 lg:w-[40%] mt-6 mb-10 rounded-full' type="text" name="query" id="query" placeholder='Add the address...' title='Add address' />
                </div>
                <motion.button
                    whileHover={{ y: -3, scale: 1.05, boxShadow: '0 0 10px rgba(255,0,0,0.3)' }}
                    className={`overflow-hidden border border-[rgba(0,0,0,0.4)] before:-translate-x-[12rem] hover:before:translate-x-0 before:block before:absolute before:-inset-3 before:skew-x-[30deg] relative inline-block bg-blue-500 text-white py-2 px-8 mx-1 rounded-full before:transition-all before:duration-500`} title='Get Images' onClick={getdata}>
